package kauesoares.eestagio.authservice;

import kauesoares.eestagio.authservice.config.properties.AuthProperties;
import kauesoares.eestagio.authservice.domain.Role;
import kauesoares.eestagio.authservice.model.User;
import kauesoares.eestagio.authservice.service.UserService;
    ...
    private void initDatabase() {
        ...
        if (this.userService.findAll().isEmpty()) {
            ...
            this.userService.save(
                    User.builder()
                            .email(authProperties.getAdminEmail())
            ...
            this.userService.save(
                    User.builder()
                            .email(authProperties.getUserEmail())
